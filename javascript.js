...
function togglePopupWindows() {
  var popupContainers = [
    ...
    document.getElementById('popup-container-11'),
    document.getElementById('popup-container-12'),
  ];
...
document.getElementById('image-11').addEventListener('click', function () {
  viewer.loadScene('image-11');
  togglePopupWindows();
});
document.getElementById('image-12').addEventListener('click', function () {
  viewer.loadScene('image-12');
  togglePopupWindows();
});
